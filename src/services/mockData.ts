...
export const mockMedicines: Medicine[] = [
  ...
  {
    id: '1b',
    name: 'Paracétamol Gén. 500mg',
    moleculeName: 'Paracétamol',
    brandName: 'Générique',
    category: 'Analgésiques',
    batchNumber: 'PARA2024001B',
    expirationDate: '2026-04-30',
    quantity: 200,
    price: 1.80,
    status: 'OK',
    manufacturer: 'PharmaCorp',
    description: 'Générique paracétamol',
  ...
  {
    id: '3b',
    name: 'Ibuprofène Gén. 400mg',
    moleculeName: 'Ibuprofène',
    brandName: 'Générique',
    category: 'Analgésiques',
    batchNumber: 'IBU2024003B',
    expirationDate: '2026-08-10',
    quantity: 80,
    price: 2.80,
    status: 'OK',
    manufacturer: 'HealthPlus',
    description: 'Générique ibuprofène',
    location: 'Rayon A - Étagère 4'
  },
  {
    id: '4',
    name: 'Glucophage 500mg',
    moleculeName: 'Metformine',
  ...
  },
  {
    ...
    moleculeName: 'Acide ascorbique',
    brandName: 'Vitamine C',
    category: 'Vitamines',
  ...
  },
  {
    id: '8',
    name: 'Aspégic 75mg',
    moleculeName: 'Acide acétylsalicylique',
    brandName: 'Aspégic',
